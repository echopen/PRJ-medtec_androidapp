...
public class FFT {
	...
	private double[] real_part_data;

	public double[] getReal_part_data() {
		return real_part_data;
	}

	public void setReal_part_data(double[] real_part_data) {
		this.real_part_data = real_part_data;
	}

	private double[] imaginary_part_data;

	public double[] getImaginary_part_data() {
		return imaginary_part_data;
	}

	public void setImaginary_part_data(double[] imaginary_part_data) {
		this.imaginary_part_data = imaginary_part_data;
	}
