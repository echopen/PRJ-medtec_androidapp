...
public class Main2Activity extends AppCompatActivity {
    ...
    private VirtualDisplay createVirtualDisplay() {
        ...
        Log.e("MEDIA RECORD SIMO ",mMediaRecorder.getSurface().isValid()+"");


        return mMediaProjection.createVirtualDisplay("Main2Activity",
                DISPLAY_WIDTH, DISPLAY_HEIGHT, mScreenDensity,
                DisplayManager.VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR, mMediaRecorder.getSurface(), null /*Callbacks*/, null/*Handler*/);
    }
        ...
        try {
            ...
            mMediaRecorder.setOutputFile(Environment
                    .getExternalStoragePublicDirectory(Environment
                            .getExternalStorageDirectory()+"/Echopen") + "/video.mp4");
