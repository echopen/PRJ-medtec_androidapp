...
public class CircularSeekBar extends View {
	...
	protected static final float DEFAULT_POINTER_RADIUS = 4f;
	protected static final float DEFAULT_POINTER_HALO_WIDTH = 3f;
	protected static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 1f;
	protected static final float DEFAULT_CIRCLE_STROKE_WIDTH = 3f;
	...
	protected static final int DEFAULT_POINTER_COLOR = Color.argb(255, 255, 255, 255);
	protected static final int DEFAULT_POINTER_HALO_COLOR = Color.argb(80, 255, 255, 255);
	...
	protected void calculateTotalDegrees() {
		mTotalCircleDegrees = (180f - (mStartAngle - mEndAngle)) % 180f; // Length of the entire circle/arc
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.translate(this.getWidth() / 2, this.getHeight());
